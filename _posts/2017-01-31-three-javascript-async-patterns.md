...
### The Verdict
If you have access to an environment with the necessary transpiler tooling, use async/await.  It provides the best of both callbacks and promises.  Aside from setting up transpilation, there is much less intellectual overhead in grokking async/await compared to promises.
